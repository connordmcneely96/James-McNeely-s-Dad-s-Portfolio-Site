...
const timeline = [
  {
    ...
    highlights: [
      ...
      'Diagnosed and resolved hardware, software, and network issues across diverse client environments',
      'Integrated and supported devices within Windows/macOS environments, Active Directory, Office 365, and cloud print services',
      'Applied TCP/IP, DNS, DHCP, and VPN knowledge to deploy and troubleshoot networked devices on client infrastructure',
      'Leveraged helpdesk and ticketing platforms to track, prioritize, and close service requests efficiently',
      'Consistently translated complex technical issues into clear, actionable guidance for non-technical clients and staff',
    ],
