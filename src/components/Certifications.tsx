...
const certifications = [
  ...
  },
  {
    ...
    description: 'CompTIA A+ validates foundational IT support skills across hardware, operating systems, networking, cybersecurity, troubleshooting, mobile devices, cloud concepts, and help desk operations. This certification demonstrates the ability to diagnose technical issues, support end users, configure devices, install software, maintain systems, and follow best practices for secure and professional IT service delivery.',
  ...
  },
  {
    ...
    description: 'Industry-standard certification validating baseline cybersecurity skills including threat analysis, risk management, incident response, and security architecture.',
